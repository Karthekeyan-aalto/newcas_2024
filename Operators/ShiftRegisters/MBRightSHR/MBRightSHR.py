...
class MBRightSHR(ShiftRegister):
    ...
    def processHWShiftRegister(self):
        ...
        #print("The output ports of the MBRightSHR", self.outputPorts)
    ...
    def configure(self):
        ...
        # access the shiftRegister bank that will be used to generate the pythonHW of the MBRightSHR
    ...
    def performHWGeneration(self):
        ...
        #print("MBRightSHR VHDL Description",self.hwVHDLDescription.vhdlDescription)
        # print the final hw instance of mbright Shr
        #print("MBRightSHR VHDL Instance", self.hwVHDLDescription.vhdlEntityDescription.vhdlEntityInstanceDefinition)
