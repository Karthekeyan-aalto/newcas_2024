...
def pcSystemModuleDirectory():
    ...
    path = os.getcwd()
    multipliersPath = os.path.abspath(os.path.join(path, os.pardir))
    #print("Multipliers Path:", multipliersPath)
