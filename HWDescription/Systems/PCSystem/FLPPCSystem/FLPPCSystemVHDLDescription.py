...
from HWDescription.Entity.Systems.PCSystem.FLPPCSystem.FLPPCSystemEntityVHDLDescription import FLPPCSystemEntityVHDLDescription
from HWDescription.Architecture.Systems.PCSystem.FLPPCSystem.FLPPCSystemArchitectureVHDLDescription import FLPPCSystemArchitectureVHDLDescription
from Operators.ShiftRegisters.MBRightSHR.MBRightSHR import MBRightSHR
from Operators.ShiftRegisters.MBRightSHR.FLPMBRightSHR.FLPMBRightSHR import FLPMBRightSHR
...
class FLPPCSystemVHDLDescription(PCSystemVHDLDescription):
    ...
    def connectHWVHDLPackages(self):
        ...
        self.vhdlEntityDescription = FLPPCSystemEntityVHDLDescription()
        # connect the hw architecture packages
        self.vhdlEntityArchitectureDescription = FLPPCSystemArchitectureVHDLDescription()
    ...
    def processHWPipelineStagesForPCTree(self):
        ...
        for level in pcTreeLevels:
            ...
            for arithmeticNode in self.childrenOfEachLevelOfPCTree[level]:
                ...
                #print("ArithmetNode VHDL Extra OutputSignals", arithmeticNode.hwDescription.vhdlEntityArchitectureDescription.extraVHDLOutputSignals)
                ...
                if arithmeticNode.swOperator.shouldInput1AndInput2BeBalanced == True:
                    ...
                    if arithmeticNode.swOperator.input1Driver.isDriverAWeight == True:
                        ...
                        # form the necessary input port details
                        inputPortDetails = [{"Name":arithmeticNode.input1,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input"}]
                        
                        # attach the pipeline registers built to the input port of the arithmetic node
                        mbRightSHR = FLPMBRightSHR()
                        mbRightSHR.configurationDetailsOfOperator = {"Name":"MBRightSHR","Frequency":arithmeticNode.frequency,"NumberSystem":arithmeticNode.numberSystem,"Number":(str(arithmeticNode.number) + "_"+"Input1"+ "_"+str(arithmeticNode.arithmeticNodeNumber)), "InputDataPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_" +"Input1"+ "_"+str(arithmeticNode.arithmeticNodeNumber)) + "Input"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}],"OutputPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_"+"Input1"+ "_"+ str(arithmeticNode.arithmeticNodeNumber)) + "Output"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Output", "ConstantSignalValue":0}],"InputClockPort":{"Name":"clk","NumberOfBits":1,"PortType":"Input","Frequency":arithmeticNode.frequency,"ConstantSignalValue":0},"InputResetPort":{"Name":"rst","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0},"InputEnablePort":{"Name":"enable","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0},"ShiftRegisterResetType":"ASYNC","Depth":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages, "Width":1,"ShiftDirection":"Right","NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
                    ...
                    if arithmeticNode.swOperator.input2Driver.isDriverAPort == True:
                        ...
                        # form the necessary input port details
                        inputPortDetails = [{"Name":arithmeticNode.input2,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}]
                        
                        # attach the pipeline registers built to the input port of the arithmetic node
                        mbRightSHR = FLPMBRightSHR()
                        mbRightSHR.configurationDetailsOfOperator = {"Name":"MBRightSHR","Frequency":arithmeticNode.frequency,"NumberSystem":arithmeticNode.numberSystem,"Number":(str(arithmeticNode.number) + "_"+"Input2"+ "_" +str(arithmeticNode.arithmeticNodeNumber)), "InputDataPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_" + "Input2"+ "_"+str(arithmeticNode.arithmeticNodeNumber)) + "Input"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}],"OutputPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_"+"Input2"+ "_"+str(arithmeticNode.arithmeticNodeNumber)) + "Output"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Output","ConstantSignalValue":0}],"InputClockPort":{"Name":"clk","NumberOfBits":1,"PortType":"Input","Frequency":arithmeticNode.frequency,"ConstantSignalValue":0},"InputResetPort":{"Name":"rst","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0}, "InputEnablePort":{"Name":"enable","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0},"ShiftRegisterResetType":"ASYNC","Depth":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages, "Width":1,"ShiftDirection":"Right","NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
                    ...
                    cascaded_MB_D_FF.configurationDetailsOfLogic = {"Name":"Cascaded_MB_D_FF","Frequency":arithmeticNode.frequency,"InputDataPorts":inputPortDetails,"Number":(arithmeticNode.name + level+"_"+str(arithmeticNode.number)),"CascadeRegisters":True,"NumberSystem":"Float","NumberOfCascadeStages":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages,"FFResetType":"ASYNC","Width":arithmeticNode.flpFlopocoNumberOfBits,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
                    ...
                    if arithmeticNode.swOperator.input1Driver.isDriverAWeight == True:
                        ...
                        # input1 is a port and input1 needs balance, Multi bit delay register needs to be added to the input1 port
                        # form the necessary input port details
                        inputPortDetails = [{"Name":arithmeticNode.input1,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}]
                        
                        # attach the pipeline registers built to the input port of the arithmetic node
                        mbRightSHR = FLPMBRightSHR()
                        mbRightSHR.configurationDetailsOfOperator = {"Name":"MBRightSHR","Frequency":arithmeticNode.frequency,"NumberSystem":arithmeticNode.numberSystem,"Number":(str(arithmeticNode.number) + "_" + str(arithmeticNode.arithmeticNodeNumber)), "InputDataPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_" + str(arithmeticNode.arithmeticNodeNumber)) + "Input"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}],"OutputPorts":[{"Name":("mbRightSHR" + (str(arithmeticNode.number) + "_" + str(arithmeticNode.arithmeticNodeNumber)) + "Output"),"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Output","ConstantSignalValue":0}],"InputClockPort":{"Name":"clk","NumberOfBits":1,"PortType":"Input","Frequency":arithmeticNode.frequency,"ConstantSignalValue":0},"InputResetPort":{"Name":"rst","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0},"InputEnablePort":{"Name":"enable","NumberOfBits":1,"PortType":"Input","ConstantSignalValue":0},"ShiftRegisterResetType":"ASYNC","Depth":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages, "Width":1,"ShiftDirection":"Right","NumberOfBits":arithmeticNode.numberOfBits, "EsBits":arithmeticNode.esBits,"MantissaBits":arithmeticNode.mantissaBits,"ExponentBits":arithmeticNode.exponentBits}
                    ...
                    if arithmeticNode.swOperator.input2Driver.isDriverAWeight == True:
                        ...
                        # input1 is a port and input1 needs balance, Multi bit delay register needs to be added to the input1 port
                        # form the necessary input port details
                        inputPortDetails = [{"Name":arithmeticNode.input2,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input"}]
                    ...
                    if len(arithmeticNode.swOperator.drivers) == 0:
                        ...
                        # form the necessary input port details
                        input1PortDetails = [{"Name":arithmeticNode.input1,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}]
                        ...
                        cascaded_MB_D_FFInput1 = FLPCascaded_MB_D_FF()
                        cascaded_MB_D_FFInput1.configurationDetailsOfLogic = {"Name":"Cascaded_MB_D_FF","Frequency":arithmeticNode.frequency,"InputDataPorts":input1PortDetails,"Number":(arithmeticNode.name + level + "_" + "Input1" + "_"+str(arithmeticNode.number)),"CascadeRegisters":True,"NumberSystem":arithmeticNode.numberSystem,"NumberOfCascadeStages":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages,"FFResetType":"ASYNC","Depth":1, "Width":arithmeticNode.flpFlopocoNumberOfBits,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
                        ...
                        input2PortDetails = [{"Name":arithmeticNode.input2,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Input","ConstantSignalValue":0}]
                        # print the inputPortDetails 
                        #print("Input1PortDetails", input2PortDetails)
                        
                        cascaded_MB_D_FFInput2 = FLPCascaded_MB_D_FF()
                        cascaded_MB_D_FFInput2.configurationDetailsOfLogic = {"Name":"Cascaded_MB_D_FF","Frequency":arithmeticNode.frequency,"InputDataPorts":input2PortDetails,"Number":(arithmeticNode.name + level + "_" + "Input2" + "_"+str(arithmeticNode.number)),"CascadeRegisters":True,"NumberSystem":arithmeticNode.numberSystem,"NumberOfCascadeStages":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages,"FFResetType":"ASYNC","Width":arithmeticNode.flpFlopocoNumberOfBits,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
        ...
        if "1" in self.childrenOfEachLevelOfPCTree.keys():
            ...
            # form the necessary input port details
            outputPortDetails = [{"Name":arithmeticNode.output,"NumberOfBits":arithmeticNode.flpFlopocoNumberOfBits,"PortType":"Output","ConstantSignalValue":0}]

            cascaded_MB_D_FFOutput = FLPCascaded_MB_D_FF()
            cascaded_MB_D_FFOutput.configurationDetailsOfLogic = {"Name":"Cascaded_MB_D_FF","Frequency":arithmeticNode.frequency,"InputDataPorts":outputPortDetails,"Number":(arithmeticNode.name + str(1) + "_" + "Output" + "_"+str(arithmeticNode.number)),"CascadeRegisters":True,"NumberSystem":arithmeticNode.numberSystem,"NumberOfCascadeStages":self.vhdlEntityArchitectureDescription.vhdlProcessDescription.pythonHWPipelineStages,"FFResetType":"ASYNC","Width":arithmeticNode.flpFlopocoNumberOfBits,"NumberOfBits":arithmeticNode.numberOfBits, "EsBits":arithmeticNode.esBits, "MantissaBits":arithmeticNode.mantissaBits, "ExponentBits":arithmeticNode.exponentBits}
                    ...
                    if inputName == arithmeticNode.input1:
                        ...
                        if arithmeticNode.swOperator.input1Driver.isDriverAnArithmeticNode == True:
                            ...
                            if arithmeticNode.isInput2PipelinedWithRegisters == True:
                                ...
                                if isinstance(arithmeticNodeInput2Register,FLPCascaded_MB_D_FF):
                                ...
                                elif isinstance(arithmeticNodeInput2Register,MBRightSHR) or isinstance(arithmeticNodeInput1Register, FLPMBRightSHR):
                                    # update the vhdl instance with two input based vhdl instances
                        ...
                        if arithmeticNode.swOperator.input2Driver.isDriverAnArithmeticNode == True:
                            ...
                            if arithmeticNode.isInput1PipelinedWithRegisters == True:
                                ...
                                if isinstance(arithmeticNodeInput1Register,FLPCascaded_MB_D_FF):
                                    
                                    arithmeticNode.hwDescription.vhdlEntityDescription.vhdlEntityInstanceDefinition = arithmeticNodeInput1Register.hwVHDLDescription.vhdlEntityArchitectureDescription.pythonHW + arithmeticNode.hwDescription.vhdlEntityDescription.vhdlEntityInstanceDefinition + cascaded_MB_D_FF.hwVHDLDescription.vhdlEntityArchitectureDescription.pythonHW + stage1Register.hwVHDLDescription.vhdlEntityDescription.vhdlEntityInstanceDefinition + stage2Register.hwVHDLDescription.vhdlEntityDescription.vhdlEntityInstanceDefinition
                                    #print("Hi again")

                                elif isinstance(arithmeticNodeInput1Register,MBRightSHR) or isinstance(arithmeticNodeInput1Register, FLPMBRightSHR):
                        ...
                        if arithmeticNode.swOperator.input1Driver.isDriverAPort == True:
                            ...
                            if arithmeticNode.shiftRegisterDelay > 0:
                                ...
                                if arithmeticNode.isInput2PipelinedWithRegisters == False:
                                    ...
                                    elif isinstance(arithmeticNodeInput2Register, MBRightSHR) or isinstance(arithmeticNodeInput2Register, FLPMBRightSHR):
                               ...
                               # check whether the input1 of the arithmeticNode is added with PipelinedRegsiters or not
                                if arithmeticNode.isInput1PipelinedWithRegisters == False:
                                    ...
                                    if isinstance(arithmeticNodeInput1Register,FLPCascaded_MB_D_FF):
                                        ...
                                        #print("Input1 based ArithmeticNode Delay",arithmeticNode.shiftRegisterDelay)
                                        #print("Level of the arithmeticNode", level)
                                        #print("Input2 name", arithmeticNode.swOperator.input2)
                                        #print("Input1 name", arithmeticNode.swOperator.input1)
                                        #print("BothInput1AndInput2NeedToBeBalanced",arithmeticNode.shouldAShiftRegisterBeAddedToInput1AndInput2)
                                        # shift registers depth needs to be updated
                                        #arithmeticNode.shiftRegisterDelay = arithmeticNode.shiftRegisterDelay \
                                                                            #+ ((len(pcTreeLevels)-int(level)+1) * mbRightSHR.depth) \
                                                                            #+ (1 + 2) \
