...
class PositAdderEntityVHDLDescription(EntityVHDLDescription):
    ...
    def configure(self):
        ...
        # check the HWPositName
        if "PositName" in configurationDetails:
            self.hwPositName = configurationDetails["PositName"]
