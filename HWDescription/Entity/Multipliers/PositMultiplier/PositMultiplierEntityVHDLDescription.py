...
Edited on December 6, 2023, 11:37
"""

from HWDescription.Entity.EntityVHDLDescription import EntityVHDLDescription

class PositMultiplierEntityVHDLDescription(EntityVHDLDescription):
    ...
    def configure(self):
        ...
        # check the HWPositFlopocoName
        if "PositFlopocoName" in configurationDetails:
            self.hwPositName = configurationDetails["PositFlopocoName"]
