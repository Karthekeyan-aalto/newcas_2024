...
from HWDescription.Process.Multipliers.FLPMultiplier.FLPMultiplierProcessVHDLDescription import FLPMultiplierProcessVHDLDescription

class FLPMultiplierArchitectureVHDLDescription(ArchitectureVHDLDescription):
    ...
    def connectHWVHDLPackages(self):
        ...
        self.vhdlProcessDescription = FLPMultiplierProcessVHDLDescription()
