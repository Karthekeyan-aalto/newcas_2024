...
class Cascaded_MB_D_FF_ArchitectureVHDLDescription(ArchitectureVHDLDescription):
    ...
    def cascadedRegisters(self,value):
        ...
        #print("CascadedRegisters", len(value))
        ...
        for index in range(0,len(self._cascadedRegisters)):
            mbDFF = self._cascadedRegisters[index]
            #print("CascadedRegisters",mbDFF.hwVHDLDescription.vhdlEntityArchitectureDescription.vhdlOutputSignals)
            self.vhdlOutputSignals = self.vhdlOutputSignals + (mbDFF.hwVHDLDescription.vhdlEntityArchitectureDescription.vhdlOutputSignals)
            #print("CascadedRegisters VHDL OutputSignals", self.vhdlOutputSignals)
            if index == 0:
                # print the vhdl input signals
                self.vhdlInputSignals = self.vhdlInputSignals + (mbDFF.hwVHDLDescription.vhdlEntityArchitectureDescription.vhdlInputSignals)
