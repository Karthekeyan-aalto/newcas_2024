...
from HWDescription.Process.Adders.FLPAdder.FLPAdderProcessVHDLDescription import FLPAdderProcessVHDLDescription


class FLPAdderArchitectureVHDLDescription(ArchitectureVHDLDescription):
    ...
    def connectHWVHDLPackages(self):
        ...
        self.vhdlProcessDescription = FLPAdderProcessVHDLDescription()
