...
class Port():
    ...
    def __generateVHDLPortSignal(self):
        # append the string to form the vhdlInstance
        if self.numberSystem == 0:
            return self._vhdlPortSignal = ("SIGNAL" + " " + self.name + ":" + self.numberSystemName + "(" + "0" \
                                                + "DOWNTO" + str((1-self.numberOfBits)) \
                                                + ")" + ":=" + "(" + "others" + "=>" + "\'0\'" + ")" + ";" + "\n")
        elif self.numberSystem == 1:
            return self._vhdlPortSignal = ("SIGNAL" + " " + self.name + ":" + self.numberSystemName + "(" + str(self.exponentBits) \
                                                + "DOWNTO" + str((1-self.mantissaBits)) \
                                                + ")" + ":=" + "(" + "others" + "=>" + "\'0\'" + ")" + ";" + "\n")
        elif self.numberSystem == 1:
            return self._vhdlPortSignal = ("SIGNAL" + " " + self.name + ":" + self.numberSystemName + "(" + str(self.numberOfBits) \
                                                + "DOWNTO" + "0" \
                                                + ")" + ":=" + "(" + "others" + "=>" + "\'0\'" + ")" + ";" + "\n")
