...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 13 14:27:51 2022
...
class MinNode():
    ...
    def __init__(self):
        ...
        """
        ===========================================================================
        Basic properites of the MinNode, that describes the ports: input and output
        ===========================================================================
        """
        self.number = 0
        self._input1 = None
        ...
        """
        ==============================
        VHDL properties of the MinNode
        ==============================
        """
    ...
    def numberSystem(self,value):
        ...
        # print numberSystem
        print("Set NumberSystem:", self._numberSystem)
    ...
    def output(self,value):
        ...
        if ((input1Float == True) and (input2Float == True)):
            # set the outputValue member variable by findin the minimum value of two inputs
            minValue = min(float(self.input1Value), float(self.input2Value))
            self.outputValue = float (minValue)
            return
    ...
    def __generateVHDLOutputSignal(self):
        print("Generate VHDLOutput with numberOfBits", self.numberOfBits)
        print("Generate VHDLOutput with output", self.output)
        print("Generate VHDLOutput with NumberSystemName", self.numberSystemName)
