...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 20 19:44:08 2022
...
class MMACUnit():
    ...
    def __init__(self):
        ...
        # properties to store the arithmeticNodes that form the compuationalUnit
        
        # Property to store the operatorArithmeticNodes (it is mostly SumNodes, or MaxNodes or MinNodes
        self.operatorArithmeticNodes = list()
        # For instance, it could be a combination of ProductNodes
        self.operandArithmeticNodes = list()
