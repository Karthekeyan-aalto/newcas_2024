...
def pcSystemModuleDirectory():
    ...
    positPCOperationPath = os.getcwd()

    #print(os.path.abspath(os.path.join(path, os.pardir)))
    operationsPath = os.path.abspath(os.path.join(positPCOperationPath, os.pardir))
...
if __name__ == "__main__":
    ...
    from Operations.PositPCOperation.PositPCOperation import PositPCOperation
    ...
    operation = PositPCOperation()
    operation.configurationDetailsOfOperation = {"Frequency":frequency,"Equation":pcEquation,"NumberOfBits":numberOfBits, "EsBits":esBits}
    operation.configure()
    operation.run()
    ...
    operation.operationPorts = sortPorts(operation.operationPorts)
