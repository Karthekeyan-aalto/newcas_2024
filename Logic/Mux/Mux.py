...
class Mux (Logic):
    """
    This class is the base class for any type of Mux that will be constructed
    The purpose of this class is to hold the basic properties including the HWDescription and HW Simulation object
    ...
    **However many other packages and modules in AutoPC are not made based on the four step process. Its lack of thought process which
    ...
    def __init__(self):
        ...
        # proeprty to connect the HW Description package
        self.connectHWDescriptionPackage()

        # property to connect the HW simulation package
