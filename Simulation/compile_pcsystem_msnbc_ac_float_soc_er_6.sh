...
vcom -work work $PWD/vhdl/AC/msnbc_tw5/32/Float/PCSystem/PCSystem_32.vhd
vcom -work work $PWD/vhdl/PCSystem_MSNBC_AC_Float_SoC_er_6.vhd
vcom -work work $PWD/vhdl/PCSystem_MSNBC_AC_Float_SoC_er_6_tb.vhd
