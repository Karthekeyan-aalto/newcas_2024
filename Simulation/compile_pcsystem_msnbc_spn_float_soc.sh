...
vcom -work work $PWD/vhdl/SPN/msnbc/22/Float/PCSystem/PCSystem_22.vhd
vcom -work work $PWD/vhdl/PCSystem_MSNBC_SPN_Float_SoC.vhd
vcom -work work $PWD/vhdl/PCSystem_MSNBC_SPN_Float_SoC_tb.vhd
